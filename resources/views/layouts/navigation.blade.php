<nav x-data="{ open: false }" class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ">
            ...
            <li class="nav-item">
                <a href="/venue/{{Auth::user()->venue}}/edit" class="nav-link">Venue</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/wedding-users">Users</a>
            </li>
            @endif
        ...
        <ul class="navbar-nav ml-md-auto ">
            <!-- <li class="nav-item">
                <a class="nav-link" href="/user/{{Auth::user()->id}}/edit"><span class="fa fa-gears"></span> My Account</a>
            </li> -->
            <li class="nav-item">
    ...
    <div class="login-dropdown hidden sm:flex sm:items-center sm:ml-6">
        <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
                <!-- Authentication -->
                <x-dropdown-link href="/user/{{Auth::user()->id}}/edit"><span class="fa fa-gears"></span> My Account</x-dropdown-link>
